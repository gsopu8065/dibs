...
let ViewCartWebService = class ViewCartWebService {
    constructor(http) {
        this.http = http;
    }
    getViewCart() {
...
ViewCartWebService = __decorate([
    core_1.Injectable(),
    __param(0, core_1.Inject(http_1.Http)), 
    __metadata('design:paramtypes', [http_1.Http])
], ViewCartWebService);
exports.ViewCartWebService = ViewCartWebService;
var searchResults = [
    {
...
//# sourceMappingURL=ViewCartWebService.js.map