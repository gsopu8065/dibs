 ...
 *
 * @RouteConfig([
 *   {path: '/header', component: HomeCmp, name: 'HomeCmp' }
 * ])
 * class MyApp {}
 * ```
 */
 ...
 *
 * @RouteConfig([
 *   new AuxRoute({path: '/header', component: HomeCmp})
 * ])
 * class MyApp {}
 * ```
 */
 ...
 *
 * @RouteConfig([
 *   {path: '/header', loader: () => Promise.resolve(MyLoadedCmp), name: 'MyLoadedCmp'}
 * ])
 * class MyApp {}
 * ```
 */
 ...
 *   {path: '/header', component: HomeCmp, name: 'Home'}
 * ])
 * class MyApp {}
 * ```
 */
